package com.wfzzkj.yifaexpdriver.view;
...
public class NumberProgressBar extends View {
    ...
    private final int default_text_color = Color.rgb(255,137,3);//Color.rgb(66, 145, 241);
    private final int default_reached_color = Color.rgb(255,137,3);
